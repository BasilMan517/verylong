...
请根据以上信息生成三段文案。中文，不要用emoji。

风格要求：
- 病程伏笔：客观、有医学依据感，像健康科普文章的语气，引用具体的生理机制或数据（如激素、指标、百分比）。不要用拟人和比喻，直接描述身体发生了什么。
- 墓志铭和最后一句话：保持黑色幽默、毒舌但不冒犯。

返回严格JSON格式（不要markdown代码块）：
{
  "foreshadow": "病程伏笔，1-2句话，客观描述这种生活方式对身体的具体影响，引用生理机制或统计数据",
