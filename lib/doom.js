...
function buildReport({ scores, tags, archetype, cause, estimatedAge, userAge }) {
  ...
  const foreshadowBank = {
    stress: [
      "皮质醇浓度已够申请危化品许可证，肾上腺正在写辞职信。",
      "神经系统对「休息」一词已读不回，自主神经开始轮流罢工。",
      "心率跟着消息通知走，手环算法已经自愧不如。",
    ],
    sleep: [
      "生物钟放弃了时区信仰，褪黑素分泌组申请调岗白班。",
      "凌晨两点大脑仍在开无议程全体会，睡眠债利率已超花呗。",
      "睡眠被当信用卡透支多年，这家银行从不减免滞纳金。",
    ],
    metabolic: [
      "胰岛素团队连续加班三千天，正在走集体维权流程。",
      "外卖算法比身体更懂需求，可惜目标函数里没有「活久一点」。",
      "代谢系统积压的外卖残留案件已从胃排到血管。",
    ],
    cardiovascular: [
      "血管内壁装修中——材料胆固醇，工期余生。",
      "心肺正在忘记全速运转的感觉，楼梯成了生死测验。",
      "祖传血压加久坐buff，心血管跑着没补丁的老版本。",
    ],
    gut: [
      "肠胃已从消化器官升级为情绪表达器官，靠疼痛发表评论。",
      "胃酸与夜宵的谈判破裂，肠道菌群正在换宿主。",
      "消化系统像被迫全年无休的便利店，店员在写离职信。",
    ],
    mood: [
      "快乐激素库存见底，正从焦虑部门借调中。",
      "精神内耗效率已超过任何实际工作，多巴胺账户余额不足。",
      "社交外包给了屏幕，屏幕只收费不售后。孤独按每天15根烟计费。",
    ],
    inflammation: [
      "体检小箭头集齐一支乐队，正在排练《慢性炎症进行曲》。",
      "免疫系统分不清敌我，对自己组织发起了持久内战。",
      "指标偏高不是错别字，是身体在用荧光笔做标记。",
    ],
  };
