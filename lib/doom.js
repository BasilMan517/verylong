export const questions = [
  ...
  },
  {
    ...
    answers: [
      ...
      { label: "外卖袋、纸巾、神秘调料包", tags: ["外卖代谢流"], scores: { metabolic: 2, gut: 1 } },
  ...
  },
  {
    ...
    answers: [
      ...
      { label: "废弃停车场，空但也没有恢复", tags: ["低活动漂浮"], scores: { mood: 2 } },
  ...
  },
  {
    ...
    answers: [
      ...
      { label: "荒漠，只有酱料和过期希望", tags: ["外卖代谢流"], scores: { gut: 2 } },
      { label: "很正常，但我主要靠公司零食活着", tags: ["工位觅食者"], scores: { stress: 2 } },
    ],
  },
  {
    id: "stairs",
    ...
    hint: "档案局把这叫作心肺诚实瞬间。",
    answers: [
      { label: "开始计算搬家的可能性", tags: ["低活动漂浮"], scores: { cardiovascular: 2 } },
  ...
  },
  {
    ...
    answers: [
      { label: "补觉到错过阳光，再用奶茶开机", tags: ["睡眠债滚息"], scores: { sleep: 3 } },
  ...
  },
  {
    ...
    answers: [
      { label: "社交润滑剂，一周两三次", tags: ["社交性饮酒"], scores: { inflammation: 3 } },
      { label: "下班回家的关机仪式", tags: ["酒精安眠药"], scores: { sleep: 2, mood: 2 } },
      { label: "偶尔喝，主要是拍照发朋友圈", tags: ["偶饮用户"], scores: { inflammation: 1 } },
  ...
  },
  {
    ...
    answers: [
      ...
      { label: "想不起来了，心脏可能已进入省电模式", tags: ["心肺待机"], scores: { cardiovascular: 3 } },
    ],
  },
  {
    id: "social",
...
export function analyzeAnswers(answerIds) {
  ...
  const comboPenalty =
    ...
    (scores.inflammation >= 3 && tags.includes("社交性饮酒") ? 2 : 0) +
...
function chooseArchetype(scores, tags) {
  if (scores.metabolic >= 7 && tags.includes("外卖代谢流")) return "外卖代谢综合体";
  if (scores.stress >= 8 && scores.sleep >= 5) return "高压日历续命者";
  ...
  if (scores.sleep >= 5) return "睡眠债滚息型";
  if (scores.inflammation >= 3 && tags.includes("社交性饮酒")) return "社交代谢双线作战";
  if (scores.mood >= 4 && tags.includes("数字社交替代")) return "屏幕社交替代人";
  if (scores.stress >= 5 && tags.includes("酒精安眠药")) return "压力液态排解型";
  if (scores.stress >= 6) return "高压日历续命者";
  if (scores.cardiovascular >= 3) return "心肺省电模式常驻";
  if (scores.mood >= 4) return "屏幕社交替代人";
  return "尚可挽回的碳基生物";
}
